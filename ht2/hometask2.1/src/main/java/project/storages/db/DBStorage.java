...
public class DBStorage implements IStorage {
    ...
    public void addMessage(MessageEntity message) {
        ...
        try (PreparedStatement preparedStatement1 = dataSource.getConnection()
            ...
            preparedStatement1.setString(1,message.getLoginReceiver());
        ...
        try (PreparedStatement preparedStatement = dataSource.getConnection()
            ...
            preparedStatement.setString(2, message.getLoginReceiver());
            preparedStatement.setObject(3, message.getLoginSender());
    ...
    private enum Commands {
        ...
        GET_USER_MESSAGES("SELECT * FROM messages WHERE loginreceiver=?"),
