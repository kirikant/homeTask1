...
public class ChatService implements IChatService {
   ...
   @Override
    ...
    public List<AuditUser> getUserAudits(String login){
        return  auditTransformer.listEntityToListDto(storage.getUserAudits(login));
    }
    ...
    public List<Message> getUserMessages(String login) {
        return messageTransformer.listEntityToListDto(storage.getUserMessages(login));
    }
